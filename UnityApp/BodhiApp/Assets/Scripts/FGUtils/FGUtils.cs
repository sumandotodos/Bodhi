...
public class SoftVector2 : SoftVector {
    ...
    TweenableSoftFloat linVar;

	public float totalLength;

	public SoftVector2() {
		linVar = new TweenableSoftFloat();
...
[System.Serializable]
public class TweenableSoftFloat:SoftVariable {
	...
	public TweenableSoftFloat(float initial) {
		prevValue = initial;
		sfvalue = initial;
